        ...
        <Container style={{ minHeight: "100vh" }}>
            ...
            <div className="mt-5" style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                <div className="w-100" style={{ maxWidth: "400px", minWidth: "200px" }}>
                    <Card style={{ maxHeight: "80vh", boxShadow: "rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px", borderRadius:"15px" }}>
                        <Card.Body>
                                ...
                                <>
                                    ...
                                    :
                                        ...
                                        <ListGroup variant="flush">
                                            {projects.map((projectDoc, i) => <ListGroup.Item style={{display:"flex", justifyContent:"space-between"}}key={i} action onClick={() => {setProject(projectDoc); history.push("/");}}>
                            ...
                            <div className="w-100 mt-4 mb-3 d-flex justify-content-evenly">
                                {currentProject && <Button variant="outline-primary" onClick={() => { history.push("/") }}>Cancel</Button>}
